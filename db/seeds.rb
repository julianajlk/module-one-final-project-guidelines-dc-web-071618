...
#Ideas
egg_pealer = Idea.create(name: "Automatic Egg Shell Pealer", description: "Peals your eggs, so you don't have to!", inventor_id: 1)
robot = Idea.create(name: "Robot Dog Walker", description: "Walks your dog, so you don't have to!", inventor_id: 2)
